...
import {
  ...
  addCampaignItemFailure,
  removeCampaignItemSuccess,
  removeCampaignItemFailure,
...
export function* fetchCampaignAccountsAsync(action) {
  ...
  try {
    const response = yield fetch(
      url + "/api/CampaignAccount/GetPaginated?" + q,
      {
        method: "GET",
        //withCredentials: true,
        credentials: "include",
...
export function* fetchCampaignOfficesAsync(action) {
  ...
  try {
    const response = yield fetch(
      url + "/api/CampaignOffice/GetPaginated?" + q,
      {
        method: "GET",
        //withCredentials: true,
        credentials: "include",
...
export function* fetchCampaignAttachmentsAsync(action) {
  ...
  try {
    const response = yield fetch(
      url + "/api/CampaignAttachment/GetPaginated?" + q,
      {
        method: "GET",
        //withCredentials: true,
        credentials: "include",
...
export function* fetchCampaignRegionsAsync(action) {
  ...
  try {
    const response = yield fetch(
      url + "/api/CampaignRegion/GetPaginated?" + q,
      {
        method: "GET",
        //withCredentials: true,
        credentials: "include",
  ...
  try {
    ...
    if (campaign.error) {
      ...
      yield put(
        fetchCampaignPackagesStart({
          params,
          payload: action.payload.Campaign.Id,
        })
      );
  ...
  try {
    ...
    if (campaign.error) {
      ...
      yield put(
        fetchAttachmentsStart({
          params,
          payload: { id: action.payload.campaignId },
        })
      );
...
export function* addCampaignRegionAsyn(action) {
  try {
    ...
    if (campaign.error) {
      ...
      yield put(
        fetchCampaignRegionsStart({ id: action.payload.campaignId, params })
      );
...
export function* campaignRequestAsync(action) {
  try {
    const currentUser = yield select(selectCurrentUser);
    const campaign = yield fetch(
      url + "/api/CampaignMember/RequestMembership",
      {
        method: "POST",
        //withCredentials: true,
        headers: {
...
export function* fetchCampaignRequestsAsync(action) {
  ...
  try {
    const response = yield fetch(
      url + "/api/CampaignRequest/GetPaginated?" + q,
      {
        method: "GET",
        //withCredentials: true,
        credentials: "include",
...
export function* fetchCampaignMembersAsync(action) {
  ...
  try {
    const response = yield fetch(
      url + "/api/CampaignMember/GetPaginated?" + q,
      {
        method: "GET",
        //withCredentials: true,
        credentials: "include",
...
export function* removeItemAsync(action) {
  try {
    ...
    const campaign = yield fetch(
      url + "/api/CampaignItem/DeleteCampaignItem?" + q,
      {
        method: "DELETE",
        //withCredentials: true,
        headers: {
    ...
    if (campaign.error) {
      yield put(
        removeCampaignItemFailure({ campaign, request: action.payload })
      );
    } else {
      yield put(
        removeCampaignItemSuccess({ campaign, request: action.payload })
      );
    }
  } catch (error) {
...
export function* fetchCampaignItems() {
  yield takeLeading(
    campaignTypes.FETCH_CAMPAIGN_ITEMS_START,
    fetchCampaignItemsAsync
  );
}
export function* fetchCampaignRequests() {
  yield takeLatest(
    campaignTypes.FETCH_CAMPAIGN_REQUESTS_START,
    fetchCampaignRequestsAsync
  );
}
export function* fetchCampaignPackages() {
  yield takeLatest(
    campaignTypes.FETCH_CAMPAIGN_PACKAGES_START,
    fetchCampaignPackagesAsync
  );
}
export function* fetchCampaignMembers() {
  yield takeLatest(
    campaignTypes.FETCH_CAMPAIGN_MEMBERS_START,
    fetchCampaignMembersAsync
  );
}
...
export function* fetchCampaignCategories() {
  ...
  yield takeEvery(
    campaignTypes.FETCH_CAMPAIGN_CATEGORIES_START,
    fetchCampaignCategoriesAsync
  );
}
...
export function* fetchCampaignAccounts() {
  yield takeEvery(
    campaignTypes.FETCH_CAMPAIGN_ACCOUNTS_START,
    fetchCampaignAccountsAsync
  );
}
export function* fetchCampaignOffices() {
  yield takeEvery(
    campaignTypes.FETCH_CAMPAIGN_OFFICES_START,
    fetchCampaignOfficesAsync
  );
}
export function* fetchCampaignAttachments() {
  yield takeEvery(
    campaignTypes.FETCH_CAMPAIGN_ATTACHMENTS_START,
    fetchCampaignAttachmentsAsync
  );
}
export function* addAttachments() {
  yield takeEvery(
    campaignTypes.ADD_CAMPAIGN_ATTACHMENT_START,
    addAttachmentsAsync
  );
}
export function* addCampaignRegion() {
  yield takeEvery(
    campaignTypes.ADD_CAMPAIGN_REGION_START,
    addCampaignRegionAsyn
  );
}
export function* fetchCampaignRegions() {
  yield takeEvery(
    campaignTypes.FETCH_CAMPAIGN_REGIONS_START,
    fetchCampaignRegionsAsync
  );
}
...
export function* fetchCampaignDetail() {
  yield takeEvery(
    campaignTypes.FETCH_CAMPAIGN_DETAIL,
