    ...
    <div>
      <PageHolder position={state.position} top={state.top}>
        ...
        <Suspense fallback={<Spinner />}>
          ...
          <Route exact path="/campaigns/:id" component={CampaignsPage} />
          <Route exact path="/campaigns/:id/:slug" component={CampaignsPage} />
          <Route exact path="/items" component={ItemPage} />
          <Route exact path="/items/:id" component={ItemPage} />
          <Route exact path="/uoms" component={UomPage} />
          <Route exact path="/requests" component={RequestPage} />
          <Route exact path="/requests/:id" component={RequestPage} />
          <Route exact path="/donation-requests" component={DonationPage} />
          <Route exact path="/donation-requests/:id" component={DonationPage} />
