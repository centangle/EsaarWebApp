...
const GridToList = ({ data, dispatch, type, handleClick, height, links,buttonsWithActions }) => {
                            ...
                            <div className='grid-links'>
                                ...
                                }
                                {
                                    links && links.map(link => {
                                        return (
                                            <Link key={link} className='link' to={`/organizations/${data[key].Id}/${link}`}>{link}</Link>
                                        )
                                    })
                                }
                                {links && <span className='link' onClick={() => handleClick(data[key])}>Details</span>}
                            </div>
                            <div className='left'>
