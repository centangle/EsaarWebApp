...
const Home = () => {
    ...
    const data = [
        { id: 1, activityType: 'One Some activity', activityDate: '20th april, 2020', organization: 'centangle', activityValue: '2000' },
        { id: 2, activityType: 'Two Some activity', activityDate: '25th april, 2020', organization: 'centangle', activityValue: '2000' },
    ];
