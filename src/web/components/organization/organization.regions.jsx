...
const OrganizationRegions = ({ regions, organizations, dispatch, organization, fetchUomStart, form, newRegions,activePage, totalItemsCount, pageRangeDisplayed, itemsCountPerPage }) => {
  useEffect(() => {
    fetchUomStart();
  }, [fetchUomStart]);
  ...
  const handlePageChange = (page) => {
    dispatch({
      type: 'FETCH_ORG_REGIONS_START', payload: organization.Id,
