    ...
    switch (match.params.slug) {
      ...
      case "campaigns":
        fetchOrgRequestsStart({
          ...
          id,
          params: { ...params, disablePagination: true },
        });
        fetchOrgRequestsStart({ type: "FETCH_ORG_ITEMS_START", id, params });
        return fetchOrgRequestsStart({
          type: "FETCH_ORG_CAMPAIGNS_START",
          id,
          params,
        });
      case "donate":
      ...
      case undefined:
        ...
        return fetchOrgRequestsStart({
          type: "FETCH_ORG_CATEGORIES_START",
          id,
          params,
        });
      default:
