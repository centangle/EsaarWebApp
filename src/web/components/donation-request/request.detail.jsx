...
const RequestDetail = ({ match, replies, request, dispatch, regions,fetchDonationItemsStart,fetchDonationDetailsStart,fetchDonationRequestThreadStart }) => {
    useEffect(()=>{
    ...
    },[fetchDonationDetailsStart,fetchDonationRequestThreadStart,fetchDonationItemsStart,match.params.id])
        ...
        <div className='page-right'>
            <ThreadHeader>
                ...
                <span className='tread-topic'>
                    {
                        request ? request.Member.Name + ' has requested to ' + request.Type + '. The current status is ' + request.DonationRequestOrganization.Status : null
                    }
                </span>
            </ThreadHeader>
            {request && request.CanUpdateStatus || true ? <RequestAdder request={request} match={match} /> : null}
