...
import {
  fetchCampaignItemsStart,
  fetchCampaignRequestsStart,
  fetchCampaignCampaignsStart,
} from "../../../common/redux/campaign/campaign.actions";
...
const CampaignDetail = ({
  ...
  useEffect(() => {
    switch (match.params.slug) {
      case "requests":
        return fetchCampaignRequestsStart({
          type: "FETCH_CAMPAIGN_REQUESTS_START",
          payload: { id },
          params,
        });
      case "packages":
        fetchCampaignRequestsStart({
          type: "FETCH_CAMPAIGN_ITEMS_START",
          payload: { id },
          params,
        });
        return fetchCampaignRequestsStart({
      ...
      case "volunteers":
        return fetchCampaignRequestsStart({
          type: "FETCH_CAMPAIGN_MEMBERS_START",
          payload: { id },
          userType: "Volunteer",
          params,
        });
      ...
      case "campaigns":
        ...
        return fetchCampaignRequestsStart({
          type: "FETCH_CAMPAIGN_CAMPAIGNS_START",
          payload: { id },
          params,
        });
      case "donate":
      ...
      case "offices":
        return fetchCampaignRequestsStart({
          type: "FETCH_CAMPAIGN_OFFICES_START",
          payload: { id },
          userType: "Offices",
          params,
        });
      case "accounts":
        return fetchCampaignRequestsStart({
          type: "FETCH_CAMPAIGN_ACCOUNTS_START",
          payload: { id },
          userType: "Accounts",
          params,
        });
      ...
      case "attachments":
        return fetchCampaignRequestsStart({
          type: "FETCH_CAMPAIGN_ATTACHMENTS_START",
          payload: { id },
          params,
        });
      case "regions":
      ...
      case undefined:
        ...
        fetchCampaignRequestsStart({
          type: "FETCH_CAMPAIGN_ATTACHMENTS_START",
          payload: { id },
          userType: "Attachments",
          params,
        });
        return fetchCampaignRequestsStart({
          type: "FETCH_CAMPAIGN_CATEGORIES_START",
          payload: { id },
          params,
        });
      default:
          ...
          <ListItems>
            <Switch>
              ...
              <Route
                exact
                path={`/campaigns/:id/${
                  slug !== "donate" && slug !== "get-donation" ? slug : "none"
                }`}
              >
                <CampaignSidebar campaign={campaign} />
              </Route>
...
const mapDispatch = (dispatch) => ({
  ...
  fetchCampaignRequestsStart: (type, id, userType) =>
    dispatch(fetchCampaignRequestsStart(type, id, userType)),
  fetchCampaignCampaignsStart: (id) =>
    dispatch(fetchCampaignCampaignsStart(id)),
  dispatch,
});
